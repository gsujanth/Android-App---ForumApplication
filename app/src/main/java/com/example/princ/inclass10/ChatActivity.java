...
public class ChatActivity extends AppCompatActivity implements MessageAdapter.DataUpdateAfterMessageDelete{
    ...
    ThreadsListResponse.MessageThread messageThread;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent() != null && getIntent().getExtras() != null) {
            if (getIntent().getExtras().containsKey("messageThreadDetails")) {
                messageThread = (ThreadsListResponse.MessageThread) getIntent().getSerializableExtra("messageThreadDetails");
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        messageAdapter= new MessageAdapter(ChatActivity.this, R.layout.messages_listview, messagesList,ChatActivity.this);
