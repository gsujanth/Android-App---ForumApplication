...
public class SignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chPwdET = findViewById(R.id.chPwdET);
        rptPwdET = findViewById(R.id.rptPwdET);
                ...
                if (signUpResponse.token != null) {
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Toast.makeText(SignUpActivity.this, "User "+signUpResponse.user_fname+" has been created", Toast.LENGTH_SHORT).show();
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(SignUpActivity.this, ""+signUpResponse.message, Toast.LENGTH_SHORT).show();
                        }
                    });
